...
public class CommitteeCategory {
    @Id
    @SequenceGenerator(name = "committee_category_id_gen", sequenceName = "committee_category_gen", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "committee_category_id_gen")
