...
public class EventCategory {
    ...
    @SequenceGenerator(name = "event_cat_id_gen", sequenceName = "event_cat_gen", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "event_cat_id_gen")
