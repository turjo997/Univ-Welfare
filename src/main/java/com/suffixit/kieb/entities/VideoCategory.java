...
public class VideoCategory {
    @Id
    @SequenceGenerator(name = "videoCategory_id_gen", sequenceName = "videoCategory_gen", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "videoCategory_id_gen")
