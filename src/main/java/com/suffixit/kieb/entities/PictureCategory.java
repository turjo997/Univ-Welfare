...
public class PictureCategory {
    ...
    @Id
    @SequenceGenerator(name = "picture_category_id_gen", sequenceName = "picture_category_gen", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "picture_category_id_gen")
    @Column(name = "id_cat", nullable = false)
    private Integer id;

    @Column(name = "category_name", length = 245)
    private String categoryName;

    @Column(name = "category_short_name", nullable = false, length = 145)
