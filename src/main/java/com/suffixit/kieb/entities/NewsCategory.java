...
public class NewsCategory {
    @Id
    @SequenceGenerator(name = "news_cat_id_gen", sequenceName = "news_cat_gen", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "news_cat_id_gen")
